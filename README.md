...
| RLBench external-trace pilot | 🟡 offline `open_drawer` ingest/verifier path implemented outside `csg/`: hardened external leakage gate, real converter, live recorder scaffold, synthetic leakage-clean fixture, and 1×N confusion all pass without RLBench installed. Live CoppeliaSim/PyRep/RLBench demo capture remains pending. |
